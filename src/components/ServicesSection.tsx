    ...
    <section className="relative w-full text-black dark:text-white py-24 px-6 md:px-10">
      ...
      <div className="max-w-7xl w-full mx-auto grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        ...
        <div className="lg:col-span-5 lg:sticky lg:top-12 space-y-8 z-10">
          ...
          {/* Section Tag */}
          <div className="inline-flex items-center gap-2 font-mono text-xs text-[#0A1128] dark:text-[#D4FF00] font-bold uppercase tracking-widest">
          ...
          <div className="pt-4">
            <a
              href="#contact"
              className="inline-flex items-center gap-3 bg-[#0A1128] dark:bg-[#D4FF00] text-white dark:text-black px-6 py-3.5 rounded-xl text-xs font-black uppercase tracking-wider border-2 border-transparent dark:border-black hover:bg-zinc-800 dark:hover:bg-white transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,0.2)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)]"
            >
            ...
            return (
              <motion.div
                ...
                className={`relative rounded-2xl border transition-all duration-300 overflow-hidden cursor-pointer ${
                  isHovered
                    ? 'bg-white dark:bg-zinc-900/90 border-[#0A1128] dark:border-[#D4FF00] shadow-[8px_8px_0px_0px_rgba(10,17,40,0.15)] dark:shadow-[8px_8px_0px_0px_rgba(212,255,0,0.15)]'
                ...
                <div className="p-6 flex items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <span
                      className={`font-mono text-xs font-bold px-2.5 py-1 rounded transition-colors ${
                        isHovered
                          ? 'bg-[#0A1128] dark:bg-[#D4FF00] text-white dark:text-black'
                    ...
                    <h3
                      className={`text-xl sm:text-2xl font-black uppercase tracking-tight font-['Cabinet_Grotesk'] transition-colors ${
                        isHovered ? 'text-[#0A1128] dark:text-[#D4FF00]' : 'text-black dark:text-white'
                      }`}
                    >
                      {service.title}
                    </h3>
                  ...
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center font-mono text-xs border transition-all ${
                      isHovered
                        ? 'bg-[#0A1128] dark:bg-[#D4FF00] text-white dark:text-black border-[#0A1128] dark:border-[#D4FF00] rotate-45'
                  ...
                  {isHovered && (
                    ...
                    >
                      <div className="px-6 pb-6 pt-2 border-t border-zinc-200 dark:border-zinc-800/80 space-y-6">
                        ...
                        <div>
                          <span className="text-[10px] font-mono text-[#0A1128] dark:text-[#D4FF00] uppercase tracking-wider block mb-1">
                            {service.subtitle}
                          </span>
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            {service.deliverables.map((item, idx) => (
                              ...
                              >
                                <span className="w-1.5 h-1.5 rounded-full bg-[#0A1128] dark:bg-[#D4FF00]" />
                                <span>{item}</span>
                              </div>
                            ))}
                          </div>
